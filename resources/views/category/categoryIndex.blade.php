...
<div class="p-4 mb-3 bg-body-tertiary rounded"> <h4 class="fst-italic">Categorias</h4> <p class="mb-0">Crie as categorias para separar os tipos de ações ecologicas.</p> </div>
<!-- 
<button class="btn btn-primary" type="button"><a href="{{ route('category.create') }}" style="text-decoration: none; color: white;">Adicionar Categoria</a></button>
<br><br><br> -->
